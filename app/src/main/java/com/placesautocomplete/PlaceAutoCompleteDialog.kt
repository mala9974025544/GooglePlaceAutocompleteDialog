...
import kotlinx.android.synthetic.main.dialog_autocomplete.view.*
...
class PlaceAutoCompleteDialog() : DialogFragment(), TextWatcher {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view = inflater.inflate(R.layout.dialog_autocomplete, null)
        val placesApi = PlaceAPI.Builder()
            .apiKey("")

            .build(requireContext())
        builder.setView(view)
        autoComplete = view.etSearchView
        btnCancel = view.btnCancel
